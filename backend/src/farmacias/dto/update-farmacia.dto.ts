...
export class UpdateFarmaciaDto extends PartialType(CreateFarmaciaDto) {
      ...
      @ApiPropertyOptional({ example: 'Rio de Janeiro', description: 'cidade da farmácia' })
      @IsOptional()
      @IsNotEmpty()
      cidade?: string;
    
      @ApiPropertyOptional({ example: 'Botafogo', description: 'Bairro da farmácia' })
      @IsOptional()
      @IsString()
      @IsNotEmpty()
      bairro?: string;
    
      @ApiPropertyOptional({ example: 'Rua das Flores', description: 'Logradouro da farmácia' })
      @IsOptional()
      @IsString()
      @IsNotEmpty()
      logradouro?: string;
