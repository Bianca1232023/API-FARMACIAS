...
export class FarmaciasController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de farmácias retornada com sucesso.',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'Nenhuma farmácia encontrada para o bairro especificado.',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'Nenhuma farmácia encontrada para a cidade especificada.',
  })
  ...
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'ID da farmácia a ser atualizada.',
  })
  @ApiBody({
    type: UpdateFarmaciaDto,
    description: 'Dados completos da farmácia para atualização.',
  })
  async update(
    @Param('id', ParseIntPipe) id: number,
    @Body() updateDto: UpdateFarmaciaDto,
  ) {
  ...
  @ApiOperation({
    summary: 'Listar farmácias que possuem um remédio específico em estoque',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de farmácias com o remédio em estoque.',
  })
  @ApiResponse({
    status: 404,
    description:
      'Nenhuma farmácia encontrada com o remédio especificado em estoque.',
  })
  @ApiParam({
    name: 'remedioId',
    type: Number,
    description: 'ID do remédio para buscar.',
  })
  async findPharmaciesByRemedioId(
